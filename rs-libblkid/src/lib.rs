...
pub enum SuperCompat {
    ...
    CompatSparseSuper2,
    CompatFastCommit,
    RoCompatOrphanPresent,
    Unknown,
}

#[derive(Debug)]
pub enum SuperIncompat {
    IncompatCompression,
    IncompatFiletype,
    IncompatRecover,
    IncompatJournalDev,
...
pub struct Ext4SuperBlock {
    ...
    pub s_feature_compat: SuperCompat,
    pub s_feature_incompat: SuperIncompat,
    pub s_feature_ro_compat: SuperROCompat,
    pub s_uuid: Uuid,
